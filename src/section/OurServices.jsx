            ...
            {tabs?.map((data) => (
              <button
                ...
                className={`flex-1 min-w-fit cursor-pointer font-medium text-sm sm:text-base md:text-lg p-3 sm:p-4 transition-all duration-300 ${
                  activeTab === data
                    ? "text-[#E8B7C1] border-b-4 border-[#E8B7C1] font-semibold shadow-xl shadow-[#8E4A54]/25"
                    : "text-muted-light hover:text-white/90 hover:border-b-2 hover:border-[#E8B7C1]/55"
                }`}
              >
                {data}
              </button>
