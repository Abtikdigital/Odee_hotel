          ...
          {filteredCards?.slice(0, visibleItems).map((card) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
                ...
                <div>
                  <button onClick={isDialogOpen} className="bg-gradient-to-r from-[#046307] to-[#0F52BA] cursor-pointer text-white px-3 sm:px-4 py-2 rounded-lg font-semibold hover:from-[#035005] hover:to-[#0D4A9F] transition-all duration-300 text-sm sm:text-base shadow-md hover:shadow-lg">
                    Rent Now
                  </button>
                </div>
              </div>
