    ...
    <section className="section-wrapper bg-premium-section space-y-10 md:space-y-14 border-b-4 border-[#d1b16a]/35 overflow-hidden">
      ...
      <div className="flex-1 space-y-3 sm:space-y-4">
          <div className="flex justify-center items-center">
            <button className="bg-gradient-to-br from-[#0f3a2c] via-[#1c5f45] to-[#d1b16a] text-white p-3 sm:p-4 rounded-2xl shadow-xl hover:shadow-2xl hover:shadow-[#0f3a2c]/35 transition-all duration-500 hover:scale-105 border-2 border-[#d1b16a]/45 hover:border-[#f0ddba] backdrop-blur-sm">
        ...
        <div className="flex-1 space-y-3 sm:space-y-4">
          <div className="flex justify-center items-center">
            <button className="bg-gradient-to-br from-[#0f3a2c] via-[#1c5f45] to-[#d1b16a] text-white p-3 sm:p-4 rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-[#0f3a2c]/35 transition-all duration-500 hover:scale-105 border-2 border-[#d1b16a]/45 hover:border-[#f0ddba] backdrop-blur-sm">
